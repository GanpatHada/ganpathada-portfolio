        ...
        <div id='blogs' className='mainblocks'>
            ...
            <div className="blogslist">
                <div id="blog1" className='blogs'>
                    ...
                    <span>Angular is a javascript based frontend framework used for creating single page application developed by Google,React is a javascript library not a framework,previously used by Facebook, was open-sourced in 2013</span>
